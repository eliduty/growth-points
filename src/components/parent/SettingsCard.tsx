...
export function SettingsCard({ title, children, className, icon: Icon, delay = 0 }: SettingsCardProps) {
  return (
    ...
    >
      {/* 标题栏 - 渐变背景 */}
      <div className="px-4 py-3 bg-gradient-to-r from-[#F9FAFB] to-[#F5F7FF] border-b border-[rgba(91,127,255,0.08)] flex items-center gap-2 text-[15px] font-semibold text-[#1F2937]">
